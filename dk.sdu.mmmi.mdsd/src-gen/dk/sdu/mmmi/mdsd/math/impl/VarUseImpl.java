 ...
 * </p>
 * <ul>
 *   <li>{@link dk.sdu.mmmi.mdsd.math.impl.VarUseImpl#getRef <em>Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VarUseImpl extends ExpressionImpl implements VarUse
{
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MathPackage.VAR_USE__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(Assignment newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MathPackage.VAR_USE__REF, oldRef, ref));
  }
