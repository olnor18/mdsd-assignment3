 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.External#getArgsType <em>Args Type</em>}</li>
 * </ul>
 *
...
public interface External extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Args Type</b></em>' attribute list.
   * The list contents are of type {@link java.lang.String}.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Args Type</em>' attribute list.
   * @see dk.sdu.mmmi.mdsd.math.MathPackage#getExternal_ArgsType()
   * @model unique="false"
   * @generated
   */
  EList<String> getArgsType();
